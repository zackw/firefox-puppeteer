...
const { Cc, Ci, CC, components: { isSuccessCode } } = require('chrome');
...
const Socket = Class({
    ...
    do_connect: function do_connect () {
        ...
        transport.setEventSink(_this.eventSink, null);
    ...
    write: function write(buffer) {
        ...
        _this.outputQueue.appendStream(chunk);
        _this.flush();
