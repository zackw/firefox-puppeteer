...
function on_error(err) {
    console.log("puppet: control socket: " + err);
    if (control_log !== null) {
...
function on_close() {
    console.log("puppet: control socket closed, exiting");
    if (control_log !== null) {
...
exports.main = function main(options, callbacks) {
    if ('PUPPETEER_SOCKET' in system.env) {
        ...
        console.log("puppet: connecting to controller at localhost:" + port);
        ...
        console.log("puppet: no control socket, inactivated");
    }
};
